...
//SPI used
	...
	#define PCD8544_SPI_IRQ				SPI1_IRQn
	#define PCD8544_SPI_BUFFER_LENGTH	50
#endif

//Default pins used
//Default RST pin
#ifndef PCD8544_RST_PIN
	#define PCD8544_RST_RCC			RCC_APB2Periph_GPIOA
...
//Default DC pin
	...
	#define PCD8544_DC_RCC			RCC_APB2Periph_GPIOA
	...
	#define PCD8544_DC_TOGGLE		PCD8544_DC_PORT->ODR ^= PCD8544_DC_PIN
#endif
//Default CE pin
#ifndef PCD8544_SCE_PIN
	#define PCD8544_SCE_RCC			RCC_APB2Periph_GPIOA
	#define PCD8544_SCE_PORT		GPIOA
	#define PCD8544_SCE_PIN			GPIO_Pin_2
	#define PCD8544_SCE_LOW			GPIO_ResetBits(PCD8544_SCE_PORT, PCD8544_SCE_PIN)
	#define PCD8544_SCE_HIGH		GPIO_SetBits(PCD8544_SCE_PORT, PCD8544_SCE_PIN)
#endif
//Default SCK pin
#ifndef PCD8544_SCK_PIN
	#define PCD8544_SCK_RCC			RCC_APB2Periph_GPIOA
	#define PCD8544_SCK_PORT		GPIOA
	#define PCD8544_SCK_PIN			GPIO_Pin_7
	#define PCD8544_SCK_LOW			GPIO_ResetBits(PCD8544_SCK_PORT, PCD8544_SCK_PIN)
	#define PCD8544_SCK_HIGH		GPIO_SetBits(PCD8544_SCK_PORT, PCD8544_SCK_PIN)
#endif
//Default MOSI pin
#ifndef PCD8544_MOSI_PIN
	#define PCD8544_MOSI_RCC		RCC_APB2Periph_GPIOA
	#define PCD8544_MOSI_PORT		GPIOA
	#define PCD8544_MOSI_PIN		GPIO_Pin_5
	#define PCD8544_MOSI_LOW		GPIO_ResetBits(PCD8544_MOSI_PORT, PCD8544_MOSI_PIN)
	#define PCD8544_MOSI_HIGH		GPIO_SetBits(PCD8544_MOSI_PORT, PCD8544_MOSI_PIN)
#endif

//Default LED pin
#ifndef PCD8544_LED_PIN

	#define PCD8544_LED_TIM			TIM2
	#define PCD8544_LED_TIM_RCC		RCC_APB1Periph_TIM2

	#define PCD8544_LED_RCC			RCC_APB2Periph_GPIOA
	#define PCD8544_LED_PORT		GPIOA
	#define PCD8544_LED_PIN			GPIO_Pin_1
//	#define PCD8544_LED_LOW			GPIO_ResetBits(PCD8544_LED_PORT, PCD8544_LED_PIN)
//	#define PCD8544_LED_HIGH		GPIO_SetBits(PCD8544_LED_PORT, PCD8544_LED_PIN)
#endif
...
/**
 * Initialize Background LED
 *
 */
extern void PCD8544_init_LED(void);

/*
 * set background light
 */
extern void PCD8544_setBackground(uint16_t value);

/**
 * Send data to LCD
 *
 */
extern void PCD8544_send(PCD8544_WriteType_t cd, unsigned char data);

/**
 * Process the interrupts for SPI.
 */
extern void PCD8544_SPI_IRQHandler() ;
/**
 * Set DC pin state
 *
 */
